...
export default function EventFormTabs({ event, initialForm, initialItems, onClose }: EventFormTabsProps) {
  ...
  const mutation = useMutation({
    mutationFn: async (publishOverride?: boolean) => {
      ...
      const payload: any = {
        ...
        allow_guests: form.allow_guests !== false,
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 z-[80] bg-background overscroll-none md:flex md:items-center md:justify-center md:bg-black/60"
