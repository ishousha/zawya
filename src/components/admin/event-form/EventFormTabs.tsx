    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="sticky bottom-0 left-0 w-full shrink-0 border-t bg-background px-3 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] z-20 max-w-full overflow-hidden shadow-[0_-2px_8px_rgba(0,0,0,0.08)] md:static md:px-4 md:py-3 md:pb-3">
