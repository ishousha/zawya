...
export default function AppHeader() {
  return (
    <header className="sticky top-0 z-40 flex items-center gap-2.5 border-b border-border/50 bg-background/95 px-4 py-2.5 backdrop-blur supports-[backdrop-filter]:bg-background/80">
