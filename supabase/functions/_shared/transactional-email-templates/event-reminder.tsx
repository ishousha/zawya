...
const bringBox = { backgroundColor: '#FEF3C7', borderLeft: '4px solid #F59E0B', borderRadius: '6px', padding: '14px 18px', margin: '0 0 16px' }
const bringLabel = { fontSize: '11px', color: '#B45309', textTransform: 'uppercase' as const, letterSpacing: '0.05em', margin: '0 0 6px', fontWeight: 'bold' as const }
const bringItem = { fontSize: '15px', color: '#1F2937', margin: '0 0 4px', lineHeight: '1.5', fontWeight: 'bold' as const }
